...
[![Version](https://img.shields.io/badge/version-0.1.5-blue)](https://github.com/lyu0805/pixshell)
...
- macOS: `PixShell-0.1.5-mac-arm64.dmg` / `PixShell-0.1.5-mac-x64.dmg`
- Windows: `PixShell-0.1.5-win-x64-setup.exe` / `PixShell-0.1.5-win-x64.zip`
