...
**Cross-platform SSH / SFTP desktop client · Terminal · Connection manager · File transfer**
...
| Tabbed SSH workspace | Groups, notes, and host icons |
...
| Compact connection editor | High-contrast light palette |
...
| --- | --- |
| **Multi-session terminal** | Tabbed SSH sessions with xterm rendering and reconnect support. |
| **Connection manager** | Groups, notes, host icons, and quick connect. |
...
- User configuration is generated on first run in the platform user-data directory.
