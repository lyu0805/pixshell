...
| File | SHA256 |
| --- | --- |
| `PixShell-0.1.1-mac-x64.dmg` | `2ea9767072faca18905960e6fe7dc20732ab8b96482f4bd816425f2d3cfa542f` |
| `PixShell-0.1.1-mac-x64.zip` | `2d8da395fc8ecbe20f9fb29c2ea8b7f88a6261c275fc47f715e677a791cc8d6b` |
...
> **Note / 说明:** macOS **arm64** artifacts are produced on Apple Silicon CI (`macos-15`). This workstation built **mac-x64** (Intel). Upload CI arm64 builds when available, or run package on arm64 host.
>
> 本机为 Intel，本地打出 **mac-x64**；**mac-arm64** 需在 Apple Silicon / CI 矩阵构建后上传。
