...
;   iscc /DMyAppVersion=0.1.4 /DPublishDir=..\publish\win-x64 win\installer\PixShell.iss
;
; Defines (overridable via /D from CI env VERSION):
;   MyAppVersion  - product version without leading v (default 0.1.4)
...
OutputDir={#OutputDir}
; Inno appends .exe → PixShell-0.1.4-win-x64-setup.exe
