...
;   iscc /DMyAppVersion=0.2.0 /DPublishDir=..\publish\win-x64 win\installer\PixShell.iss
;
; Defines (overridable via /D from CI env VERSION):
;   MyAppVersion  - product version without leading v (default 0.2.0)
...
OutputDir={#OutputDir}
; Inno appends .exe → PixShell-0.2.0-win-x64-setup.exe
