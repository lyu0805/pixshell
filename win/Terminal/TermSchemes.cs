...
public static class TermSchemes
{
    ...
    private static readonly Raw[] RawTable =
    {
        ...
        new("pix-dark", "Pix Dark (Default)", "#002945", "#ffffff", "#00d05c", "#05609f", new[] { "#555555", "#ff2222", "#38de21", "#ffe50a", "#1460d2", "#ff005d", "#00bbbb", "#bbbbbb", "#555555", "#f40e17", "#3bd01d", "#edc809", "#5555ff", "#ff99ff", "#6ae3fa", "#ffffff" }),
