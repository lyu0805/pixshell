...
enum SysInfoParser {
    ...
    private static func apply(key: String, value: String, into info: inout SysInfo) {
        ...
        case "cpu_busy": info.cpu.busyPct = Double(value.replacingOccurrences(of: "%", with: ""))
        case "cpu_user": info.cpu.userPct = Double(value.replacingOccurrences(of: "%", with: ""))
        case "cpu_system": info.cpu.systemPct = Double(value.replacingOccurrences(of: "%", with: ""))
        case "cpu_idle": info.cpu.idlePct = Double(value.replacingOccurrences(of: "%", with: ""))
        case "cpu_iowait": info.cpu.iowaitPct = Double(value.replacingOccurrences(of: "%", with: ""))
